                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <table
                                                                                            ...
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>የሚወዳደሩበት የስራ ክፍል/ የስራ መደብ</td>
                                                                                                    <td>{{ $hr->form->job_category->job_category }}/{{ $hr->form->position->position }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>ለትምህርት ዝግጅት የሚሰጥ
                            ...
                            <div class="table-responsive">
                                <table id="datable_8" class="table table-hover table-bordered w-100 pb-30">
                                    ...
                                    <tbody>
                                        ...
                                        $j = 0;
                                        ?>
                                        @foreach ($secondhrs as $l => $hr)
                                            @if ($hr->form->choice2->position_type_id == 1)
                                                @if ($hr->status_hr == 0)
                                                    <tr>
                                                        <td>{{ ++$j }}</td>
                                                        <td>{{ $hr->form->full_name }} <p>{{ $hr->form->email }}
                                                            </p>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm">
                                                                    ...
                                                                    <!-- Modal -->
                                                                    <div class="modal fade" id="id2_{{ $i }}"
                                                                        tabindex="-1" role="dialog"
                                                                        aria-labelledby="exampleModalCenter" aria-hidden="true">
                                                                        <div class="modal-dialog modal-dialog-centered"
                                                                            role="document">
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button" class="btn btn-primary requestStat2 btn-sm "
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <div id="element-to-print">
                                                                                ...
                                                                                <h5 class="modal-title "
                                                                                    id="exampleModalLongTitle">
                                                                                    የተወዳዳሪው 2ኛ ምርጫ ከደረጃ በላይ አጠቃላይ ውጤት
                                                                                </h5>
                                                                                <div class="modal-body">
                                                                                    <table
                                                                                        class="table table-hover table-bordered w-100  pb-30">
                                                                                        ...
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    @foreach ($hr->form->education as $i => $type)
                                                                                                        ({{ $type->level }},
                                                                                                        {{ $type->discipline }},{{ $type->academicPreparationCOC }},
                                                                                                        {{ $type->completion_date }})
                                                                                                        ,
                                                                                                    @endforeach
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>የሚወዳደሩበት የስራ ክፍልና የስራ መደብ</td>
                                                                                                <td>{{ $hr->form->jobcat2->job_category }}/{{ $hr->form->choice2->position }}
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>

                                                                                                <td>ለትምህርት ዝግጅት የሚሰጥ ነጥብ(25%)
                                                                                                </td>
                                                                                                <td>{{ $hr->performance }}</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td>ለስራ ልምድ አገልግሎት የሚሰጥ ነጥብ(15%)
                                                                                                </td>
                                                                                                <td> {{ $hr->experience }}</td>
                                                                                            </tr>
                                                                                            <tr>
...
@section('javascript')
    ...
    <script>
        ...
        $(".requestStat2").on("click", function() {
            // var element = document.getElementById("element-to-print")
            var element = $(this).closest("tr").find("#element-to-print")[0]
            html2pdf(element, {
                margin: 9,
