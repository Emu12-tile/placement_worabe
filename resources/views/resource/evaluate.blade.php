                            ...
                            <div class="row mt-40">
                                ...
                                @role('hr')
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input class="form-control @error('performance') is-invalid @enderror" id="performance"
                                            placeholder="ለትምህርት ዝግጅት" value="{{ old('performance') }}" type="number"
                                            name="performance" min="1" max="25" required>
                                        @error('performance')
                                            <span class=" error invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input class="form-control @error('experience') is-invalid @enderror" id="experience"
                                            ...
                                            name="experience" min="1" max="15" required>
                                        @error('experience')
                                            <span class=" error invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input class="form-control @error('exam') is-invalid @enderror" id="exam"
                                            ...
                                            name="exam" min="1" max="15" required>
                                        @error('exam')
                                            <span class=" error invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
