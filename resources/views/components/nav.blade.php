<nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar" style=" background-color:#8696FE;
">
    ...
    <a class="navbar-brand" href="{{ route('home') }}">
        ...
        <img class="brand-img d-inline-block " src="{{ asset('assets/dist/img/wer.png') }}"
        ...
        {{-- <h5 class="text-white font-24 font-weight-600 ml-50 "> ወራቤ ዩኒቨርሲቲ</h5> --}}
        {{--  ለአመልካቾች ግምገማ --}}
    </a>
