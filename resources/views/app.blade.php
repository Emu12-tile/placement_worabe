            ...
            <footer class="footer">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <p>Developed for<a href="" class="text-dark" target="_blank">AASTU</a> ©
                            2023</p>
                    </div>
                    {{-- <div class="col-md-6 col-sm-12">
