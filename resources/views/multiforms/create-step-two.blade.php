                ...
                <div class="col-xl-12">
                    ...
                    <section class="hk-sec-wrapper mt-100">
                        ...
                        <div class="row">
                            ...
                            <button class="text-gold text-left mt-3 mb-4 mr-150" style=" background-color:rgb(17,40,77)">
                                ምርጫ 1</button>
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select class="form-control custom-select d-block w-100  positionofone" id="position_id"
