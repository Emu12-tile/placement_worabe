                                    ...
                                    <div class="col-sm">
                                        ...
                                        <div class=" formgr row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" name="addMoreInputFields[0][startingDate]" value="{{ $form->startingDate ?? '' }}" class="form-control  @error('startingDate') is-invalid @enderror" id="startingDate" placeholder=" ">
                                                @error('startingDate')
                                                <span class=" error invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" min="startingDate" name="addMoreInputFields[0][endingDate]" value="{{ $form->endingDate ?? '' }}" class="form-control  @error('endingDate') is-invalid @enderror" id="endingDate" placeholder=" endingDate">
                                                @error('endingDate')
                                                <span class=" error invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="addMoreInputFields[0][positionyouworked]" value="{{ $form->positionyouworked ?? '' }}" class="form-control  @error('positionyouworked') is-invalid @enderror" id="positionyouworked" placeholder="የሰሩበት የስራ መደብ">
