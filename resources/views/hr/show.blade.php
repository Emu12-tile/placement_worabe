                        ...
                        <div class="col-sm">
                            <form action=""method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="inputname" class="col-sm-2 col-form-label">የትምህርት ደረጃ,የትምህርት ዝግጅት</label>

                                    <div class="col-sm-10">
                                        @foreach ($edu as $fo)
                                            <input type="text"
                                                value="{{ $fo->edu_level->education_level }} , {{ $fo->education_type->education_type }}"
                                                name="education_level"class="form-control " id="inputEmail3"
                                                readonly>
                                        @endforeach
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" value="{{ $form->job_category->job_category }}"
                                            name="job_category"class="form-control " id="inputEmail3"
                                            readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" value="{{ $form->jobcat2->job_category }}"
                                            name="job_category"class="form-control " id="job_category"
                                            readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text"
                                            ...
                                            name="" class="form-control" id="inputname"
